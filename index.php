...
<body id="page-top">
  ...
  $result_jadwal = mysqli_query($connection, "SELECT * FROM jadkul ORDER BY id_jadkul");
  ?>
              ...
              <div class="col-lg-8">
                ...
                <div>
                  ...
                  while ($data_mahas = mysqli_fetch_array($result_mahasiswa)) {
                    ...
                    echo "<td>".$data_mahas['tanggal_lahir']."</td>";
                    echo "<td>".$data_mahas['nama_prodi']."</td>";
                   echo "<td> 
            ...
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <div>
                  ...
                  <?php
                  $no = 1;
                  while ($data_karyawan = mysqli_fetch_array($result_karyawan)) {
                    echo "<tr>";
                    echo "<td>".$no++. "</td>";
                    echo "<td>".$data_karyawan['id_karyawan']."</td>";
                    echo "<td>".$data_karyawan['nama_karyawan']."</td>";
                    echo "<td>".$data_karyawan['no_telp']."</td>";
                    echo "<td>".$data_karyawan['divisi']."</td>";
                    echo "<td> 
                    <a class='btn btn-success' href='edit_karyawan.php?id_karyawan=$data_karyawan[id_karyawan]'>Edit</a> 
                   <a class='btn btn-danger' onclick = 'deleteConfirm(event)' href='delete_karyawan.php?id_karyawan=$data_karyawan[id_karyawan]'>
                   <i class='fas fa-trash fa-fw'></i>Delete</a>
                   </td>
                   </tr>";
                  }
             ...
             <a class="btn btn-primary" href="add_karyawan.php">
              <i class="fas fa-plus fa-fw"></i>
              Tambah Karyawan
                </a>
              </div>
