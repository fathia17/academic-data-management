...
$result_program_studi = mysqli_query($connection, "SELECT * FROM program_studi ORDER BY id_prodi ASC");
?>
...
include_once'koneksi_db.php';
  ...
  $result = mysqli_query($connection, "INSERT INTO mahasiswa VALUES ('$nrp','$nama','$tanggal_lahir','$jenis_kelamin','$id_prodi')");
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <form action="add_mahas.php" method="post" ">
